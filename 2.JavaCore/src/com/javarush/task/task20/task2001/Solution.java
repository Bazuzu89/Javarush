...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("Тест10", null);
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            bufferedWriter.write(isNamePresent + "\n");
            ...
            if (assets != null) {
                for (Asset asset : assets) {
                    String isAssetPresent = asset != null ? "yes" : "no";
                    bufferedWriter.write(isAssetPresent + "\n");
                    bufferedWriter.flush();
                    if (asset != null) {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String isAssetsPresent = bufferedReader.readLine();
