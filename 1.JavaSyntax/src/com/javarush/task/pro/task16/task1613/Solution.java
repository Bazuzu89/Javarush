...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        if (weekDay < FRIDAY || weekDay > SUNDAY) {return false;}
        else if (weekDay == FRIDAY && time < WEEKEND_START_FRIDAY_CUT_OFF_HOUR) {return false;}
        else if (weekDay == SUNDAY && time >= WEEKEND_END_SUNDAY_CUT_OFF_HOUR) {return false;}
        else {
            return true;
        }
